      ...
      {glossaryList.map((glossary, i) => (
        ...
        >
          <input
            ...
            autoFocus
            style={{ display: editingGlossary === glossary._id ? "block" : "none" }}
          />
          <span style={{ display: editingGlossary === glossary._id ? "none" : "block" }}>
            {glossary.name} {defaultGlossary === glossary.name && <strong>(기본)</strong>}
          </span>
          <div className="glossary-buttons">
            <button
              ...
              style={{ display: editingGlossary === glossary._id ? "none" : "block" }}
            >
              기본
            </button>
            <button
